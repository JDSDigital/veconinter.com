$(function () {
    ...
    $('.landing-slider-3').parallax({imageSrc: './img/containers.jpg'});
    ...
    $('.contact-city-select').on('change', function() {
        var select = $(this);
        var selectId = select[0].id;
        var tab = selectId + select.val();

        $('ul.' + selectId + ' li.selected').removeClass('selected');
